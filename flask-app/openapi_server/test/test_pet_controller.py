...
class TestPetController(BaseTestCase):
    ...
    def test_add_pet(self):
        ...
        """
        pet = {"photoUrls":["photoUrls","photoUrls"],"name":"doggie","id":10,"category":{"name":"Dogs","id":1},"tags":[{"name":"name","id":0},{"name":"name","id":0}],"status":"available"}
        headers = { 
    ...
    def test_upload_file(self):
        ...
        response = self.client.open(
            '/api/v3/pet/{pet_id}/uploadImage'.format(pet_id=56),
            method='POST',
            headers=headers,
